...
init -1 python hide:
    ...
    config.window_title = u"Кровавая Луна"
    ...
    config.main_menu_music = "sounds/music/main.mp3"

    config.window_icon = "images/gui/icon.png"
    config.windows_icon = "images/gui/icon.png"
...
python early:
    config.save_directory = "Criminal Dimston-1507582946"
